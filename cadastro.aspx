...
<head>
    ...
    <script language="javascript" type="text/javascript">
        function validate() {
            ...
            var RGUsuario = document.querySelector('.validaRGCampo');
            ...
            if (document.getElementById('txtRg').value == "" || document.getElementById('txtRg').value == null) {
                RGUsuario.style.display = "block";
                document.getElementById('txtRg').focus();
                return false;

            } else {

                RGUsuario.style.display = "none";
            ...
            */
            ...
            if (valorformaIngresso == "0") {
                ...
                formaIngresso.style.display = "none";
    ...
    <script>
        function upload() {
            ...
            if (valorformaIngresso == 1) {
                document.querySelector('.validaVestibularCampo').style.display = "block";
                document.querySelector('.validaTransferenciaCampo').style.display = "none";
                document.querySelector('.validaEnemCampo').style.display = "none";
                document.querySelector('.validaPortadorCampo').style.display = "none";
            }
            if (valorformaIngresso == 2) {
                document.querySelector('.validaVestibularCampo').style.display = "none";
                document.querySelector('.validaTransferenciaCampo').style.display = "none";
                document.querySelector('.validaEnemCampo').style.display = "block";
                document.querySelector('.validaPortadorCampo').style.display = "none";
            }
            if (valorformaIngresso == 3) {
                document.querySelector('.validaVestibularCampo').style.display = "none";
                document.querySelector('.validaTransferenciaCampo').style.display = "none";
                document.querySelector('.validaEnemCampo').style.display = "none";
                document.querySelector('.validaPortadorCampo').style.display = "block";
            }
            if (valorformaIngresso == 4) {
                document.querySelector('.validaVestibularCampo').style.display = "none";
                document.querySelector('.validaTransferenciaCampo').style.display = "block";
                document.querySelector('.validaEnemCampo').style.display = "none";
                document.querySelector('.validaPortadorCampo').style.display = "none";
            }
            ...
            <div class="row">
                <aside class="col-sm-6">
                    ...
                    <h3 class="subtitle-doc">Formulário para Cadastro
                                    ...
                                    <div class="form-group">
                                        <label>RG</label>
                                        <input type="text" class="form-control" id="txtRg" name="txtRg" placeholder="">
                                        <span class="alert-danger validaRGCampo" style="display:none">O <strong>RG </strong>é obrigatório.
                                        </span>
                                    </div> <!-- form-group end.// -->
                                         ...
                                         <div class="form-row">
                                            ...
                                            <select id="formaIngresso" name="formaIngresso" class="form-control select2" onchange="mensagemTipoVestibular()">
                                                <option value="0">Selecione uma forma de ingresso</option>                                             
                                                  ...
                                                  <span class="alert-danger validaformaIngressoCampo" style="display:none"><strong>Escolha uma forma de ingresso.</strong>
                            </span>
...
<script>
    var NMHOST = "Service.asmx?op=cursoCampus";

    function cursoCampus() {

        var select = document.getElementById('inputCampus');
        var valorformaIngresso = select.options[select.selectedIndex].value;

        var URLWEBSERVICE = "https://" + NMHOST;
        var soapRequest = '<?xml version="1.0" encoding="utf-8"?><soap12:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://www.w3.org/2003/05/soap-envelope"> <soap12:Body>    <cursoCampus xmlns="http://tempuri.org/">      <campusId>' + valorformaIngresso + '</campusId>   </cursoCampus>  </soap12:Body></soap12:Envelope>'
        ...
        function processSuccess(data, status, req) {
            ...
            var nova = $(req.responseXML).find("cursoCampusResult").text();
            document.getElementById('inputCurso').innerHTML = nova;
